...
private:
    ...
    wpi::array<SwerveModuleSubsystem, 4> m_swerveModules{
        SwerveModuleSubsystem{1, 2, 0, 0.56285_tr},   //0.563827_tr
        SwerveModuleSubsystem{4, 3, 1, 0.576021_tr},   // 1   //0.439079
        SwerveModuleSubsystem{5, 6, 2, 0.978818_tr},    //0.959607
        SwerveModuleSubsystem{8, 7, 3, 0.451288_tr}};   // 3      //0.569833
