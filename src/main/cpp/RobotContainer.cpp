...
void RobotContainer::ConfigureButtonBindings()
{
    ...
    frc2::JoystickButton(&m_joystick, 1).WhenHeld(FeederSpinupCommand(0.25, m_flywheel));
    frc2::JoystickButton(&m_joystick, 1).WhenReleased(FeederSpinupCommand(0.0, m_flywheel));
    frc2::JoystickButton(&m_joystick, 4).WhenPressed(FeederSpinupCommand(0.25, m_flywheel));
    ...
    frc2::JoystickButton(&m_joystick, 6).WhenPressed(MainFeederSpinupCommand(0.25, m_flywheel));
    ...
    frc2::JoystickButton(&m_joystick, 7).WhenPressed(IntakeSpinupCommand(0.25, m_flywheel));
    ...
    frc2::JoystickButton(&m_joystick, 16).WhenPressed(IntakeSpinupCommand(0.25, m_flywheel));
    frc2::JoystickButton(&m_joystick, 16).WhenPressed(MainFeederSpinupCommand(0.25, m_flywheel));
    frc2::JoystickButton(&m_joystick, 16).WhenPressed(FeederSpinupCommand(0.25, m_flywheel));
}
