...
=======
    ...
    frc2::JoystickButton(&m_joystick, 4).WhenPressed(TurretCommand(35, m_turretSystem));
    frc2::JoystickButton(&m_joystick, 3).WhenPressed(TurretCommand(-35, m_turretSystem));
    frc2::JoystickButton(&m_joystick, 4).WhenPressed(TurretCommand(0, m_turretSystem));
    frc2::JoystickButton(&m_joystick, 3).WhenPressed(TurretCommand(0, m_turretSystem));
    /*
